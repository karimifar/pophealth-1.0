...
<head>
	...
	<link rel="shortcut icon" href=<?php echo get_template_directory_uri() . "/img/icon.ico" ?> type="image/x-icon">
    <link rel="icon" href=<?php echo get_template_directory_uri() . "/img/icon.ico" ?> type="image/x-icon">
	<?php wp_head(); ?>
</head>
