<?php
/**
 * pophealth_1.0 functions and definitions
 *
...
if ( ! function_exists( 'pophealth_1_0_setup' ) ) :
	/**
	 ...
	 */
	function pophealth_1_0_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on pophealth_1.0, use a find and replace
		 * to change 'pophealth_1-0' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'pophealth_1-0', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'pophealth_1-0' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'pophealth_1_0_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'pophealth_1_0_setup' );
 ...
 */
function pophealth_1_0_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'pophealth_1_0_content_width', 640 );
}
add_action( 'after_setup_theme', 'pophealth_1_0_content_width', 0 );
 ...
 */
function pophealth_1_0_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'pophealth_1-0' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'pophealth_1-0' ),
...
add_action( 'widgets_init', 'pophealth_1_0_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function pophealth_1_0_scripts() {
...
add_action( 'wp_enqueue_scripts', 'pophealth_1_0_scripts' );
